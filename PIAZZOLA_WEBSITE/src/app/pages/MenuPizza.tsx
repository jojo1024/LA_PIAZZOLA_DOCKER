...
const MenuPizza = () => {
  ...
  const listePizzaFiltres = useMemo(() => {
    ...
    if (recherchePizza.length === 0) return listePizzaUniquement;

    const rechercheNormalisee = normalizeString(recherchePizza.toLowerCase());

    return listePizzaUniquement.filter(item =>
  ...
  }, [recherchePizza, listePizzaUniquement]);
    ...
    <Suspense fallback={<PageLoader />}>
      ...
      >
        ...
        <div className=" w-full py-5 bg-red-600 mt-4">
          ...
          >
            Nous avons une variété de {listePizzaUniquement?.length} pizzas
          </Heading>
        </div>
                              ...
                              >
                                ...
                                <div className="ml-3 sm:ml-6 ">
                                  ...
                                  <div className="mt-4 md:mt-10 mx-1">
                                    <CustomButton onClick={() => handleOpenModalChoixComplementPizza(elt, setOpenModal, setChoixPizzaSelectionnee)} title='Commandez' width='w-full' iconSvg={<PizzaIconSvg color='white' />} />
                                  </div>
                                </div>
                              </div>
                            </div>
