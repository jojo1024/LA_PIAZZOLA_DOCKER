...
import { checkInViewIntersectionObserver } from "../../../utils/functions";
...
const NcImage: FC<NcImageProps> = ({
  ...
  const renderLoadingPlaceholder = () => {
    return (
      <div
        className={`${className} flex items-center justify-center bg-slate-300 dark:bg-neutral-6000 text-neutral-100 dark:text-neutral-500`}
      >
